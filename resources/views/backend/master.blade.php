    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Manager</a>
            <a class="collapse-item" href="buttons.html">Orphan</a>                    
            <a class="collapse-item" href="cards.html">Volunteer</a> 
            <a class="collapse-item" href="cards.html">Staff</a>          
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item" href="buttons.html">Donation</a>
            <a class="collapse-item" href="cards.html">Adoption</a>
            <a class="collapse-item" href="cards.html">Events</a>
            <a class="collapse-item" href="cards.html">Blogs</a>
            <a class="collapse-item" href="cards.html">Requirement</a>
            <a class="collapse-item" href="cards.html">Expense</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Shop items</a>
